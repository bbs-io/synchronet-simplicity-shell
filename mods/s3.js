...
bbs.menu.email = function() {
	...
	bbs.menu.show_simple("s3/email","Email: ",options,NODE_RMAL);
}
...
bbs.menu.message = function() {
	...
	options['R'] = "bbs.scan_posts(msg_area.grp_list[bbs.curgrp].sub_list[bbs.cursub].code,SCAN_NEW|SCAN_BACK);",
	...
	//basic menu, will display the menu text & prompt
	//  then get the available input, and execute the associated command.
	bbs.menu.show_simple("s3/message","[@GRP@ - @SUB@] Message: ",options,NODE_RMSG);
}
